...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var titlescreen_1 = require("./titlescreen");
...
},{"./titlescreen":6}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var InputManager = /** @class */ (function () {
    function InputManager() {
        this.mPressed = new Collections.Set();
        this.mLastPressed = new Collections.Set();
    }
    InputManager.GetInstance = function () {
        return InputManager.mInstance;
    };
    InputManager.prototype.isDown = function (keyCode) {
        return this.mPressed.contains(keyCode);
    };
    InputManager.prototype.pressed = function (keyCode) {
        return this.mPressed.contains(keyCode) && !this.mLastPressed.contains(keyCode);
    };
    InputManager.prototype.isUp = function (keyCode) {
        return !this.mPressed.contains(keyCode);
    };
    InputManager.prototype.released = function (keyCode) {
        return !this.mPressed.contains(keyCode) && this.mLastPressed.contains(keyCode);
    };
...
},{"typescript-collections":22}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var $ = require("jquery");
...
$(function () {
    ...
    var fpsList = [0];
    // add input listeners
    window.addEventListener('keyup', function (event) { input_1.InputManager.GetInstance().onKeyup(event); });
    window.addEventListener('keydown', function (event) { input_1.InputManager.GetInstance().onKeydown(event); });
...
},{"./config":1,"./game":2,"./input":3,"jquery":7}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var input_1 = require("./input");
var game_1 = require("./game");
var config_1 = require("./config");
var OptionsScreen = /** @class */ (function () {
    function OptionsScreen(prevScreen) {
        this.prevScreen = prevScreen;
        this.options = ["Clear High Scores", "Back"];
        this.selected = this.options.length - 1;
    }
    OptionsScreen.prototype.update = function (deltaTime) {
    ...
    OptionsScreen.prototype.draw = function (ctx, deltaTime) {
        ctx.fillStyle = 'red';
        ctx.font = "32pt 'Press Start 2P'";
        var titleText = "OPTIONS";
        var xPos = (config_1.CANVAS_WIDTH - ctx.measureText(titleText).width) / 2;
        var yPos = config_1.CANVAS_HEIGHT / 2;
...
},{"./config":1,"./game":2,"./input":3}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var input_1 = require("./input");
var game_1 = require("./game");
var config_1 = require("./config");
var optionsscreen_1 = require("./optionsscreen");
var TitleScreen = /** @class */ (function () {
    ...
    TitleScreen.prototype.chooseGame = function () {
    };
    TitleScreen.prototype.chooseOptions = function () {
        console.log("Hello!");
        game_1.game.SetUpScreen(optionsscreen_1.OptionsScreen);
    };
    TitleScreen.prototype.chooseHelp = function () {
    };
    TitleScreen.prototype.chooseCredits = function () {
    };
    TitleScreen.prototype.draw = function (ctx) {
        ctx.fillStyle = 'white';
        ctx.font = "64pt 'Press Start 2P'";
        var titleText = "Bee Dodger";
        ...
        for (var i = 0; i < this.menuItems.length; i++) {
            ...
            var menuText = (i === this.selected ? "- " : "") + this.menuItems[i];
            var xPos = 150 + (i === this.selected ? 50 : 0);
            var yPos = 400 + i * 50;
...
},{"./config":1,"./game":2,"./input":3,"./optionsscreen":5}],7:[function(require,module,exports){
/*!
...
},{"./Queue":18,"./util":23}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var util = require("./util");
...
},{"./Dictionary":10,"./Set":19,"./util":23}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var util = require("./util");
...
},{"./Dictionary":10,"./util":23}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./arrays":21,"./util":23}],13:[function(require,module,exports){
"use strict";
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
},{"./Dictionary":10,"./util":23}],14:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var util = require("./util");
var arrays = require("./arrays");
...
},{"./arrays":21,"./util":23}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var util = require("./util");
var Dictionary_1 = require("./Dictionary");
...
},{"./Dictionary":10,"./arrays":21,"./util":23}],16:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var Direction;
(function (Direction) {
...
},{"./Heap":12,"./util":23}],18:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./LinkedList":14}],19:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var util = require("./util");
var arrays = require("./arrays");
...
},{"./Dictionary":10,"./arrays":21,"./util":23}],20:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var LinkedList_1 = require("./LinkedList");
...
},{"./LinkedList":14}],21:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var util = require("./util");
/**
...
},{"./BSTree":8,"./Bag":9,"./Dictionary":10,"./FactoryDictionary":11,"./Heap":12,"./LinkedDictionary":13,"./LinkedList":14,"./MultiDictionary":15,"./MultiRootTree":16,"./PriorityQueue":17,"./Queue":18,"./Set":19,"./Stack":20,"./arrays":21,"./util":23}],23:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
